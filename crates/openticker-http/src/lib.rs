...
mod tests {
    ...
    async fn dashboard_root_returns_html() {
        ...
        assert!(html.contains("OpenTicker Operator Workspace"));
    }
    ...
    async fn dashboard_section_routes_return_html() {
        let app = build_router(fixture_state());
        let routes = [
            (DASHBOARD_ACTIVITY_PATH, "data-initial-page=\"activity\""),
            (DASHBOARD_BOTS_PATH, "data-initial-page=\"bots\""),
            ("/bots/demo-bot", "data-initial-page=\"bots\""),
            (DASHBOARD_CONFIG_PATH, "data-initial-page=\"config\""),
            (
                DASHBOARD_CONNECTORS_PATH,
                "data-initial-page=\"connectors\"",
            ),
            (DASHBOARD_CYCLES_PATH, "data-initial-page=\"cycles\""),
            ("/cycles/trc_test", "data-initial-page=\"cycles-detail\""),
            (DASHBOARD_FEEDS_PATH, "data-initial-page=\"feeds\""),
            ("/feeds/demo%2Ffeed%2F1m", "data-initial-page=\"feeds\""),
            (DASHBOARD_PROVIDERS_PATH, "data-initial-page=\"providers\""),
            (DASHBOARD_PORTFOLIO_PATH, "data-initial-page=\"portfolio\""),
        ];
