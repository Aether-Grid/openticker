//! Shared fixture-directory and bundle-builder helpers for openticker-config tests.
...
pub(super) fn connector_validation_bundle(
...
pub(super) fn default_validation_account() -> AccountConfig {
    AccountConfig {
...
pub(super) fn default_validation_instance() -> InstanceConfig {
    InstanceConfig {
...
pub(super) fn intrabar_validation_account() -> AccountConfig {
    AccountConfig {
...
pub(super) fn intrabar_validation_instance() -> InstanceConfig {
    InstanceConfig {
...
pub(super) fn create_fixture_dir(prefix: &str) -> PathBuf {
...
pub(super) fn write_file(path: PathBuf, content: &str) {
