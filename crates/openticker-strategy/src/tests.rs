...
use openticker_core::{
    ...
    IndicatorSignalPolicy, SignalMetadata, SignalStrength, TradeIntent,
};
...
fn single_indicator_filters_entry_by_strength_when_available() {
    ...
    let filters = IndicatorSignalMetadataFilters {
        entry: openticker_core::SignalMetadataFilter {
            allowed_strengths: vec![SignalStrength::Strong],
            ..openticker_core::SignalMetadataFilter::default()
        },
        exit: openticker_core::SignalMetadataFilter::default(),
    };
