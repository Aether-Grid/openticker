use crate::common::{Sma, crossover, crossunder};
...
impl SmaCrossoverIndicator {
    ...
    fn update_inner(&mut self, bar: &OhlcvBar, phase: SignalPhase) -> SmaCrossoverSnapshot {
...
impl IndicatorEngine for SmaCrossoverIndicator {
    type Snapshot = SmaCrossoverSnapshot;
